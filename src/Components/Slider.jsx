...
const Scroll = () => {
  const slideImages = [
    ...
    },
    {
      ...
      description:
        "We are dedicated to advancing medicine and improving lives through our wide range of pharmaceuticals and biomedical equipment. We strive to provide the latest and most effective solutions to healthcare professionals.",
      btn: "",
    },
    {
      url: slide3,
      ...
      description:
        "Easter Light Pharma is a leader in biomedical innovation, supplying cutting-edge pharmaceuticals and medical equipment to the healthcare industry. We are committed to driving progress and improving patient outcomes through their products.",
      btn: "",
    },
  ];
  return (
      ...
      <Slide>
        {slideImages.map((slideImage, index) => (
          <div className="h-screen  each-slide " data-aos="fade-up" key={index}>
            <div
              className="md:hidden relative h-screen w-full bg-cover bg-center  backdrop-blur-lg "
              ...
              <div className="absolute h-screen w-full opacity-90 backdrop-blur-sm">
                <div className="absolute pt-40 text-gray-700    h-auto w-full text-center px-8">
                  <div className="flex  flex-col gap-8 text-center">
                    <h1>
                      <span className=" sm:text-4xl text-center   font-bold">
                        {slideImage.caption}
                      </span>
                    </h1>
            ...
            {/* Desktop */}
            <div
              className="sm:hidden md:block  relative h-screen w-full bg-cover bg-center  backdrop-blur-lg"
              style={{ backgroundImage: `url(${slideImage.urldesk})` }}
            >
              <div className="absolute h-screen w-full opacity-90 backdrop-blur-sm desktop-bg ">
                <div className="absolute left-[10%] top-36 w-[85%]  pt-40 text-white h-auto px-8">
                  <div className="flex flex-col gap-8 sm:text-center md:text-left">
                    <h1>
                      <span
                        className="text-4xl font-bold md:text-6xl md:w-[90%] "
                        data-aos="fade-up"
                      >
                        {slideImage.caption}
                      </span>
                    ...
                    <div className="flex flex-col gap-8">
                      <p
                        className="text-md w-[60%] md:text-xl"
                        data-aos="fade-up"
                      >
                        {slideImage.description}
                      </p>
