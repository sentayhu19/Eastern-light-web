...
const ErrorAlert = ({ message }) => {
  ...
  return (
    <div className="fixed right-0 top-8 p-4 bg-red-500 text-white rounded-lg shadow-md animation-slide-right">
      <div className="flex items-center gap-3">
        <FontAwesomeIcon
          icon={faXmark}
          className=" text-white text-3xl border rounded-lg w-8 "
        />
        <p> {message}</p>
      </div>
