        ...
        return ( 
            <div >
                <div className=" items-center justify-center text-black py-10">
                    <h1 className="text-center text-3xl font-bold mb-10 "data-aos="fade-up">OUR PARTNERS</h1>
                    <div className='grid grid-cols-3  md:w-[60%] sm:w-[90%] m-auto' data-aos="fade-up">
